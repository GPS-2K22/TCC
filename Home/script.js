const AutoCompleteValue =[
    ...
    {name : "print", syntax :'Escrever("mensagem")', usage: "Escrever uma mensagem no console"},
    {name : "print", syntax :'Escrever("mensagem", variavel)', usage: "Escrever uma mensagem no console"},
    // Conditionals
    {name : "if", syntax : 'Se', usage: "Condicional"},
    {name : "if", syntax :'Se(valor_1 == valor_2)', usage: "Condicional"},
    {name : "if", syntax :'Se(valor_1 >= valor_2)', usage: "Condicional"},
    {name : "if", syntax :'Se(valor_1 <= valor_2)', usage: "Condicional"},
    {name : "if", syntax :'Se(valor_1 > valor_2)', usage: "Condicional"},
    {name : "if", syntax :'Se(valor_1 < valor_2)', usage: "Condicional"}
    ...
    identyCommand(command,lang){
        ...
        if(lang == "JAVA"){ // -> Tortoise
            ...
            if(this.identyType(command) == "print_no_var"){
                ...
                let value_2 = afterCommand.split(verifyConditional(afterCommand,simbols))[1]
...
function translateCommand(){
        ...
        switch(LangSelect){
            case 'Python':
                ...
                break;
            case 'JAVA':
                //JAVA_args.returnJAVA(commandFromUser);
